          ...
          <li class="media">
            ...
            <div class="media-body">
             ...
             <li class="media">
              {{-- <img class="mr-3" src="/template_home/img/1.png" alt="Generic placeholder image"> --}}
              <div class="media-body">
                <h5 class="mt-0 mb-1"><b>Prosedur Donor Darah</b></h5>
              <li class="list-group list-group-numbered">1. Tahap Registrasi</li>
                <p>Menyerahkan formulir pendaftaran ke petugas</p>
              <li class="list-group list-group-numbered">2. Tahap Pemeriksaan Pendahuluan</li>
                <p>
                a. Pengukuran berat badan <br>
                b. Pemeriksaan kadar haemoglobin darah <br>
                c. Pemeriksaan golongan darah bagi pendonor pemula
                </p>
              <li class="list-group list-group-numbered">3. Tahap Pemeriksaan Kesehatan</li>
                <p>
                a. Anamnesis<br>
                b. Pemeriksaan tekanan darah <br>
                c. Pemeriksaan fisik sederhana
                </p>
              <li class="list-group list-group-numbered">4. Tahap Pengambilan Darah Donor</li>
                <p>
                a. Cuci lengan donor <br>
                b. Pengambilan darah <br>
                c. Pengambilan sampel darah
                </p>
              <li class="list-group list-group-numbered">5. Tahap Adiministrasi</li>
                <p>
                Menga,bil kartu donor dan vitamin.
                </p>
              <li class="list-group list-group-numbered">6. Tahap Pemulihan</li>
                <p>
